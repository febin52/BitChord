...
Grab the latest signed APK from the [Releases](https://github.com/febin52/BitChord/releases) page. Sideloading requires enabling "Install unknown apps" for whichever app you download it with.
